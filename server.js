...
"use strict";
/* unused harmony export nodeEnv */
var env = process.env;

var nodeEnv = env.NODE_ENV || 'development';

/* harmony default export */ __webpack_exports__["a"] = ({
  OAUTH: '313a40654efbd4b7eb226a3a962ab1b8e1553d34',
  user: 'booellean',
  perPage: 300,
  port: env.PORT || 9001,
  ...
  //https://api.github.com/user/repos?per_page=1000&access_token=313a40654efbd4b7eb226a3a962ab1b8e1553d34
...
"use strict";
throw new Error("Module build failed: SyntaxError: C:/Users/BooGirl/Desktop/NuCamp/3-React/elle-tech/src/api/render.js: await is a reserved word (191:14)\n\n\u001b[0m \u001b[90m 189 | \u001b[39m          \u001b[36mreturn\u001b[39m res\u001b[33m.\u001b[39mmap( item \u001b[33m=>\u001b[39m{\n \u001b[90m 190 | \u001b[39m            \u001b[36mreturn\u001b[39m(\n\u001b[31m\u001b[1m>\u001b[22m\u001b[39m\u001b[90m 191 | \u001b[39m              await fetch(\u001b[32m`https://api.github.com/orgs/${item}`\u001b[39m\u001b[33m,\u001b[39m {\n \u001b[90m     | \u001b[39m              \u001b[31m\u001b[1m^\u001b[22m\u001b[39m\n \u001b[90m 192 | \u001b[39m                method\u001b[33m:\u001b[39m \u001b[32m'GET'\u001b[39m\u001b[33m,\u001b[39m\n \u001b[90m 193 | \u001b[39m                mode\u001b[33m:\u001b[39m \u001b[32m'cors'\u001b[39m\u001b[33m,\u001b[39m\n \u001b[90m 194 | \u001b[39m                credentials\u001b[33m:\u001b[39m \u001b[32m'include'\u001b[39m\u001b[33m,\u001b[39m\u001b[0m\n");
...
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_1__api_render__ = __webpack_require__(71);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_1__api_render___default = __webpack_require__.n(__WEBPACK_IMPORTED_MODULE_1__api_render__);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_2__api_config__ = __webpack_require__(41);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_3__api_index__ = __webpack_require__(186);
...
app.get('*', function (req, res) {
  ...
  __WEBPACK_IMPORTED_MODULE_1__api_render__["default"].fetchContribRepos(req).then(function (data) {
...
app.listen(__WEBPACK_IMPORTED_MODULE_2__api_config__["a" /* default */].port, __WEBPACK_IMPORTED_MODULE_2__api_config__["a" /* default */].host, function () {
  console.log('Server is listening on ' + __WEBPACK_IMPORTED_MODULE_2__api_config__["a" /* default */].host + ':' + __WEBPACK_IMPORTED_MODULE_2__api_config__["a" /* default */].port);
});
...
var bytes = __webpack_require__(90)
var createError = __webpack_require__(9)
var iconv = __webpack_require__(46)
...
module.exports = {
    ...
    'gbk': {
        type: '_dbcs',
        table: function() { return __webpack_require__(30).concat(__webpack_require__(47)) },
    },
    'xgbk': 'gbk',
    'isoir58': 'gbk',
    ...
    'big5hkscs': {
        type: '_dbcs',
        table: function() { return __webpack_require__(48).concat(__webpack_require__(106)) },
...
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_0_express__ = __webpack_require__(42);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_0_express___default = __webpack_require__.n(__WEBPACK_IMPORTED_MODULE_0_express__);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_1__render__ = __webpack_require__(71);
...
router.get('/repos/:repoId', function (req, res) {
  res.send('ReposId');
...
router.get('/open-source/:orgId', function (req, res) {
  res.send('OrgsId');
  // mdb.collection('contests')
  //   .findOne({ _id: ObjectID(req.params.contestId) })
  //   .then(contest => res.send(contest))
...
router.get('/programmer', function (req, res) {
  // let contests = {};
  // mdb.collection('contests').find({})
  //   .project({
  //     categoryName: 1,
